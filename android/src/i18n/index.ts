...
const fr = {
  ...
  cadence:        'Cadence',
  energy:         'Énergie',
  noTrack:        'Sans trace GPS',
  unknownActivity:'Activité',
  departure:      'Départ',
  arrival:        'Arrivée',
  ...
  workoutCalendarWaiting: 'en attente de place (la montre en affiche 5), prochain',
...
const en: typeof fr = {
  ...
  workoutCalendarWaiting: 'waiting for room (the watch shows 5), next',
